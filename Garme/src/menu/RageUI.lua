...
RageUI.Settings = {
    ...
    Items = {
        ...
        Background = { Dictionary = "evstream", Texture = "gradient_bgd", Y = 0, Width = 431 },
        Navigation = {
            Rectangle = { Width = 431, Height = 18 },
            Offset = 5,
            Arrows = { Dictionary = "evstream", Texture = "shop_arrows_upanddown", X = 190, Y = -6, Width = 50, Height = 50 },
        },
        Description = {
            Bar = { Y = 4, Width = 431, Height = 4 },
            Background = { Dictionary = "evstream", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 30 },
...
print("----------------------------------------------")
print("Script Vente Arme by Galaxie Geek#1486")
print("https://discord.gg/qBPjHQfzm8")
print("----------------------------------------------")